class DataValues {
  ...
  static Uri githubURL = Uri.parse('https://github.com/vivekbargude');
  static Uri linkedinURL = Uri.parse('https://linkedin.com/in/vivekbargude');
  static Uri twitterURL = Uri.parse('https://leetcode.com/u/1S9rRFDBSL/');
  ...
  static const String headerName = 'Vivek Bargude';
  static const String headerTitle = 'Student | Developer | Problem Solver ';
  ...
  static const String aboutMeDescription =
      'Enthusiastic Android developer with a strong foundation in Java/Kotlin/Flutter and hands-on experience through academic projects and internships. Eager to bring innovative ideas and cutting-edge mobile solutions to life while growing within a dynamic development team. Driven by a passion for creating seamless user experiences and a commitment to continuous learning in the ever-evolving tech landscape.';
  ...
  static const String contactEmail = 'vivekbargude1206@gmail.com';

  // Footer
  static const String copyright =
      "Copyright ©2025 Vivek Bargude. All Rights Reserved.";
